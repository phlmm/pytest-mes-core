...
class EnvironmentValidator:
    ...
    def verify_target_dependencies(
        ...
        if missing_binaries:
            ...
            logger.critical("Check your Yocto/Buildroot image configuration or packagegroup recipe!")
    ...
    def verify_system_health(cls, dut: DutTransport) -> ValidatorResult:
        ...
        try:
            ...
            if dmesg_res.ok and dmesg_res.stdout.strip():
                logger.error("[Pre-Flight] Kernel panic traces detected in early boot!")
