...
from pytest_mes_core.config import PsuVendorConfig, RigolPsuConfig, KeysightPsuConfig, StateMachineConfig, HostSerialConfig, HostMqttConfig
...
def test_state_machine_config_fix6_fields_roundtrip():
    ...
    data = {'gpio_reset_pin': 'RESET_N', 'gpio_recovery_pin': 'BOOT0', 'recovery_latch_time_s': 2.5, 'power_off_threshold_a': 0.1, 'boot_straps_gpio_map': {'emmc': {'BOOT0': True, 'BOOT1': False}}, 'storage_data_encrypted': '/dev/mapper/custom_crypt'}
