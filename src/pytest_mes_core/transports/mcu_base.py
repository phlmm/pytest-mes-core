...
class McuTransport(Protocol):
    ...
    async def async_connect(self) -> None:
        """Attaches the debug probe to the target MCU asynchronously."""
        ...

    async def async_disconnect(self) -> None:
        """Detaches the debug probe to prevent state leakage asynchronously."""
        ...

    async def async_halt(self) -> None:
        """Pauses the CPU core asynchronously."""
        ...

    async def async_resume(self) -> None:
        """Resumes execution of the CPU core asynchronously."""
        ...

    async def async_reset(self) -> None:
        """Triggers a physical or vector-catch reset of the MCU asynchronously."""
        ...

    async def async_read_memory(self, address: int, size: int) -> bytes:
        """Reads a block of memory from the MCU SRAM/Flash asynchronously."""
        ...

    async def async_write_memory(self, address: int, data: bytes) -> None:
        """Writes a block of memory to the MCU SRAM/Flash asynchronously."""
        ...

    async def async_read_core_register(self, reg_name: str) -> int:
        """Reads an internal CPU register asynchronously."""
        ...
