...
PANIC_PAYLOADS = [b'Kernel panic - not syncing: VFS: Unable to mount root fs', b'Unable to handle kernel paging request at virtual address', b'Oops - undefined instruction', b'Out of memory: Killed process 1234 (myapp)', b'BUG: soft lockup - CPU#0 stuck for 22s', b'rcu_preempt detected stalls on CPUs/tasks', b'task blocked for more than 120 seconds', b'synchronous external abort', b'mmc0: error -110', b'mmc1: error -5', b'EXT4-fs error (device mmcblk2p2): ext4_validate_block_bitmap:376', b'UBIFS error (ubi0:0 pid 123): ubifs_scan_a_node', b'HAB Events', b'SEC_ERR', b'Signature Verification Failed']
